...
class HParameters:
    ...
    def __init__(self):
        ...
        self.datasets=['datasets/object_features/eccv16_dataset_summe_google_pool5.h5',
                       'datasets/object_features/eccv16_dataset_tvsum_google_pool5.h5',
                       ]
        self.kinetic_features="./datasets/kinetic_features/"
        

        self.splits = ['splits/summe_splits.json','splits/tvsum_splits.json']
